...
void elastic_limit_parameters::validate()const {
   ...
   EOS_ASSERT( periods > 0, invalid_resource_limit_param, "elastic limit parameter 'periods' cannot be zero" );
   EOS_ASSERT( contract_rate.denominator > 0, invalid_resource_limit_param, "elastic limit parameter 'contract_rate' is not a well-defined ratio" );
   EOS_ASSERT( expand_rate.denominator > 0, invalid_resource_limit_param, "elastic limit parameter 'expand_rate' is not a well-defined ratio" );
}
